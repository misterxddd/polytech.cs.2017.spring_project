...
*
### Рекурсивная функция, с помощью которой каждому символу приписыается новая кодировка. Создается массив указателей на структуру "pop"(string), массив состоит из 256 ячеек. Когда функция, проходясь по дереву, доходит до узла с символом, она записывает список, состоящий из 0 и 1, в i-ую ячейку массива (где i - кодировка данного символа в таблице ASCII).
\param[in] root Начальный узел.
